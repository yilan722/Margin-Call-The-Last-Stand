    ...
    <div className="z-30 w-full h-full bg-slate-950 overflow-y-auto overscroll-contain" style={{ WebkitOverflowScrolling: 'touch' }}>
      ...
      <div className="sticky top-0 z-10 bg-gradient-to-b from-slate-900 to-transparent pb-4 md:pb-8 pt-4 md:pt-8 px-4 md:px-16 border-b border-slate-800">
        <div className="flex justify-between items-center mb-4 md:mb-6">
          <h1 className="orbitron text-2xl md:text-5xl font-black text-white tracking-tighter">{i18n.t('darkPoolShop.title')}</h1>
          <button
            onClick={onBack}
      ...
      {/* Tabs */}
      <div className="px-4 md:px-16 pt-4 md:pt-8 flex space-x-2 md:space-x-4 border-b border-slate-800">
        {/* 装备系统暂时关闭 */}
        {/* <button
        ...
        <button
          ...
          className={`px-4 md:px-8 py-2 md:py-4 orbitron text-xs md:text-base font-black uppercase tracking-widest transition-all ${
