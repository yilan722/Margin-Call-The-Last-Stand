      ...
      <div className="min-h-full flex items-center justify-center py-8 md:py-12 px-2 md:px-4">
        ...
        <div className="relative z-10 mb-6 md:mb-8">
          <div className="flex justify-between items-center mb-4 md:mb-6">
            <h1 className="orbitron text-2xl md:text-5xl font-black text-cyan-400 tracking-tighter">关卡简报</h1>
          </div>
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-4">
            <div className="flex-1">
              <div className="text-xl md:text-3xl font-black text-white orbitron mb-2">{scenario.name}</div>
              <div className="text-slate-400 text-xs md:text-sm">{scenario.description}</div>
            </div>
        ...
        <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 mb-6 md:mb-8">
          ...
          <div className="space-y-4 md:space-y-6">
            <div className="bg-slate-950 border border-slate-800 p-4 md:p-6">
              <div className="text-slate-500 text-xs orbitron uppercase tracking-widest mb-3 md:mb-4">账户状态</div>
              <div className="space-y-3 md:space-y-4">
                <div className="flex justify-between items-center">
                  <span className="text-slate-400 text-xs md:text-sm">当前本金</span>
                ...
                <div className="flex justify-between items-center">
                  <span className="text-slate-400 text-xs md:text-sm">目标金额</span>
                ...
                <div className="h-px bg-slate-800"></div>
                <div className="flex justify-between items-center">
                  <span className="text-slate-400 text-xs md:text-sm">需盈利</span>
            ...
            {/* Progress Bar */}
            <div className="bg-slate-950 border border-slate-800 p-4 md:p-6">
              <div className="text-slate-500 text-xs orbitron uppercase tracking-widest mb-3 md:mb-4">目标进度</div>
          ...
          <div className="space-y-4 md:space-y-6">
            <div className="bg-slate-950 border border-slate-800 p-4 md:p-6">
              <div className="text-slate-500 text-xs orbitron uppercase tracking-widest mb-3 md:mb-4">历史背景</div>
              <div className="text-white text-base md:text-lg font-bold mb-2">{scenario.year}年</div>
            ...
            <div className="bg-slate-950 border border-slate-800 p-4 md:p-6">
              <div className="text-slate-500 text-xs orbitron uppercase tracking-widest mb-3 md:mb-4">关卡信息</div>
              <div className="space-y-2 md:space-y-3">
                <div className="flex justify-between">
                  <span className="text-slate-400 text-xs md:text-sm">难度</span>
                  <span className="text-amber-500 font-bold">{'★'.repeat(scenario.difficulty)}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-400 text-xs md:text-sm">时长</span>
                  <span className="text-white font-bold">{scenario.duration || 60}秒</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-400 text-xs md:text-sm">推荐杠杆</span>
        ...
        <div className="relative z-10 bg-amber-950/30 border-2 border-amber-500/50 p-4 md:p-6 mb-6 md:mb-8">
          <div className="flex items-start space-x-3 md:space-x-4">
            ...
            <div className="flex-1 min-w-0">
              <div className="text-amber-400 font-bold mb-2 orbitron uppercase tracking-widest text-xs md:text-sm">警告</div>
